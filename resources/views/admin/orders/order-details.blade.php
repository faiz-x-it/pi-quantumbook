            ...
            <div class="container-fluid">
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        ...
                        <p><i class="fas fa-map-marked"></i> <span class="mx-2">{{$order->shipping->address}},{{$order->shipping->kota->kota_name}}-{{ $order->shipping->province->province_name}}</span></p>
                        <p><i class="fas fa-shopping-cart"></i><span class="mx-2"> {{$order->shipping->layanan}}</span></p>
